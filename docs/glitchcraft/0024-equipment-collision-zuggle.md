...
## Raw row
```csv
Glitch: Equipment Collision Zuggle, Glitch Overview: The original zuggle method discovered by Zvleon., How To: 1) Stand infront of a wall. (about 1 link away from it) (facing away from it)
...
8) Unpause and switch weapons, Working Versions: 1.0.0

1.1.0/1.1.1, Credit: Zvleon, Date: May 16, 2023, See Also: Zuggle, Effects/Extensions: Zuggle has many ways of being executed, this is the oldest one. Map Zuggling is the most reccomended method for pre-1.1.2
For 1.1.2, see FEZ and smuggle stacking zuggling (and FEWZ)
```
